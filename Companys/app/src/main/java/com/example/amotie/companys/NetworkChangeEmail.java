...
public class NetworkChangeEmail extends AsyncTask<String,Void,String[]> {
    private WeakReference<Settings> activityWeakReference;
    NetworkChangeEmail(Settings activity){
    ...
    protected String[] doInBackground(String... strings) {
        ...
        String UserUpdateUrl="https://bestdiscounteg.com/Android/updateCompanies/updateEmail.php";
        try {
            String id=strings[0];
    ...
    protected void onPostExecute(String[] s) {
        ...
        if(s[0].equals("Record Updated")){
            ...
            Toast.makeText(activity,"Cant Update Email",Toast.LENGTH_SHORT).show();
            activity.progressBar.setVisibility(View.INVISIBLE);
            activity.relativeLayout.setVisibility(View.VISIBLE);
        }
